...
<div class="card" style="max-width: 500px; margin: 0 auto;">
	<div class="card-header">
		<h5 class="mb-0"><i class="bi bi-calendar3 me-2 text-primary"></i>Add Semester</h5>
	</div>
	<div class="card-body">
		<form method="post" action="{{ route('semesters.store') }}">
			...
			<div class="mb-3">
				...
				<input name="semester_name" class="form-control" value="{{ old('semester_name') }}" placeholder="e.g., Fall 2024" required>
